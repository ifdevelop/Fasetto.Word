...
namespace Fasetto.Word.Core
{
    ...
    public class FileManager : IFileManager
    {
        ...
        /// <param name="append"> If true, writes the text to the of the file, otherwise overrides any existing file</param>
        /// <returns></returns>
        public async Task WriteTextToFileAssync(string text, string path, bool append = false)
        {
            // TODO: Add exception catching

            // Normalize and resolve path
            path = NormalezePath(path);
        ...
        /// <returns></returns>
        public string NormalezePath(string path)
        {
            // If on Windows
