...
{
    /// <summary>
    /// Match the label width of all text entry contrils inside this panel
    /// </summary>
    public class TextEntryWidthMatherProperty : BaseAttachedProperty<TextEntryWidthMatherProperty, bool>
    {
