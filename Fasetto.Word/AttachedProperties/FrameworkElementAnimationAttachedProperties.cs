...
{
    /// <summary>
    /// A base class to run any animation method when a boolean set to true
        ...
        where Parent : BaseAttachedProperty<Parent, bool>, new()
    {
        ...
        public override void OnValueUpdated(DependencyObject sender, object value)
        {
            ...
            // Don't fire if the value doesm't change
            ...
            if(FirstLoad)
            {
                ...
                onLoaded = async (ss, ee) =>
                {
                    ...
                    // Slight delay after load is needed for some elemnts to get laid out
